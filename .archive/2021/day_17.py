...
class Target:
    ...
    def distance_from_target(self, probe):
        x_distance = self.__get_distance(
            probe.current_position.x, self.min_x, self.max_x
        )
        y_distance = self.__get_distance(
            probe.current_position.y, self.min_y, self.max_y
        )
...
class Probe:
    ...
    def launch_towards(self, target: Target):
        ...
        while True:
            self.current_position = self.current_position.new_by_adding(
